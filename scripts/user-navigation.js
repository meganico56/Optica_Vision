// user-navigation.js - Maneja la navegación entre secciones del panel de usuario
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const savedSection = localStorage.getItem('userActiveSection') || 'dashboard';
    ...
    function switchSection(sectionName) {
        ...
        if (targetSection) {
            ...
            localStorage.setItem('userActiveSection', sectionName);
        }
    }
